...
הקוד כולל ממשק, טיימר, אינטגרציית Teachable Machine, שרת Gemini, מצב הדגמה ובדיקות אוטומטיות. כדי להפעיל החלטות Gemini יש להגדיר מפתח API ולבדוק חיבור אמיתי. מצב הדגמה אינו תחליף ל־Agent בהגשת הקורס. קישור לאתר יתווסף לאחר פרסום ובדיקה ב־Vercel.
